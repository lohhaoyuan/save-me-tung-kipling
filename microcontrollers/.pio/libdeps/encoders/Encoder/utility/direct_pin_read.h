...
// Define IO_REG_TYPE for STM32F4
#define IO_REG_TYPE uint32_t

// PIN_TO_BASEREG macro for STM32F4
#define PIN_TO_BASEREG(pin)  ((volatile uint32_t*)(GPIOA_BASE + 0x10))

// PIN_TO_BITMASK macro for STM32F4
#define PIN_TO_BITMASK(pin) (1 << ((pin) & 0x0F))

// DIRECT_PIN_READ macro for STM32F4
#define DIRECT_PIN_READ(base, mask) ((HAL_GPIO_ReadPin(GPIOA, mask) == GPIO_PIN_SET) ? 1 : 0)
